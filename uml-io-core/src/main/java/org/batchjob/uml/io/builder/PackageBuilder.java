...
public class PackageBuilder extends AbstractPackageBuilder<Package, PackageBuilder> {
	...
	@Override
	protected void integrate(Package pack, Package parent) {
		parent.getNestedPackages().add(pack);
	}
